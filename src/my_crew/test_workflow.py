...
research_task = Task(
    ...
    expected_output="""
    A structured summary of multi-agent AI systems.
    """,
...
planning_task = Task(
    description="""
    Create an execution plan based on the research findings.
    """,
...
execution_task = Task(
    description="""
    Execute the proposed workflow plan.
    """,

    expected_output="""
    Execution summary and operational steps.
    """,
...
validation_task = Task(
    description="""
    Validate the execution results and identify issues.
    """,
